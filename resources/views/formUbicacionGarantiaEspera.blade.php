...
<div class="content-formulario content-alta" >
    <div class="contact-wrapper">
        <div class="modifica-form alta">
            ...
            <form action="/cambiarEstadoPedidoP/{{ $pedido->idPedido }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <p>
                    ...
                    <select disabled name="idUsuario" id="idUsuario">
                ...
                <p>
                    ...
                    <select   name="idUsuarioAlquiler" id="idUsuarioAlquiler">
                        <option value="">Seleccione una Cuenta</option>  
                        @foreach($usuario as $userA)
                            <option value="{{$userA->id}}">{{$userA->name}} {{$userA->apellido}}</option>
                        @endforeach
                    </select>
